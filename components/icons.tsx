...
export const SparklesIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.393c-.842.07-1.173 1.14-.557 1.704l3.523 3.356-1.001 4.88c-.192.928.745 1.635 1.53 1.198L10 15.331l4.002 2.48c.784.437 1.722-.27 1.53-1.198l-1.001-4.88 3.523-3.356c.616-.564.285-1.634-.557-1.704l-4.753-.393-1.83-4.401Z" clipRule="evenodd" />
    </svg>
);
...
export const CpuChipIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5M12 4.5v-1.5m0 18v-1.5M15.75 21v-1.5M18 8.25h1.5M18 15.75h1.5M12 18.75v1.5M18 12h1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75V15m0 0V11.25M12 15a1.5 1.5 0 0 1-1.5-1.5V12a1.5 1.5 0 0 1 1.5-1.5Zm0 0a1.5 1.5 0 0 0 1.5-1.5V12a1.5 1.5 0 0 0-1.5-1.5Zm0 0V9m0 0V7.5M12 9a1.5 1.5 0 0 1 1.5 1.5V12a1.5 1.5 0 0 1-1.5 1.5Zm0 0a1.5 1.5 0 0 0-1.5 1.5V12a1.5 1.5 0 0 0 1.5 1.5Z" />
    </svg>
);
...
export const BullseyeIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 15.91a4.5 4.5 0 1 0-6.364-6.364 4.5 4.5 0 0 0 6.364 6.364Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a5.25 5.25 0 0 1-1.04-1.58l-1.932-3.863a3.75 3.75 0 0 0-2.308-2.307l-3.863-1.932a5.25 5.25 0 0 1-1.58-1.04l.537-3.722a2.1 2.1 0 0 1 2.193-1.98H16.5c.969 0 1.813.616 2.097 1.5M15.75 15.75-2.25 2.25" />
    </svg>
);
